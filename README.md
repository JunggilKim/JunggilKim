...
| 프로젝트 | 기간 | 한 일 | 결과 |
| :--- | :---: | :--- | :---: |
| 🍽️ **[YOBI](https://github.com/barleylover/YOBI)** | 2026.07–08 | 외국인 관광객을 위한 음식 추천 및 설명 서비스<br>• 사용자 선택에 따른 메뉴 추천과 메뉴 설명 제공<br>• Hybrid search/RAG 활용<br>• React·FastAPI 기반 서비스 구현<br>• Oracle Database 연동 및 OCI 배포 | **🏆 요기요 × 오라클<br>AI 해커톤 우수상<br>(2nd place)** |
...
| 🧬 **[TRIAL-OPT](https://github.com/JunggilKim/Healthcare_Agent)** | 2026.08–09 | 임상시험 사전 선별을 위한 연구 프로토타입<br>• 검색 단서와 판정 근거를 분리하는 Evidence Firewall 구현<br>• 부족한 정보를 우선순위에 따라 묻고 답변 후 판정을 재검증하는 흐름 개발<br>• FastAPI·React 기반 오프라인 데모와 Google Cloud 배포 | **🏆 Healthcare Agentic AI Challenge 2026<br>우수상 (3rd place)** |
...
| 학년 | 학교 | 전공 |
| :---: | :--- | :--- |
| 4학년(졸업예정) | **성균관대학교** | 수학과·소프트웨어학과 복수전공 |
...
| **Cloud / Tools** | ![OCI](https://img.shields.io/badge/OCI-F80000?style=flat-square&logo=oracle&logoColor=white) ![Docker](https://img.shields.io/badge/Docker-2496ED?style=flat-square&logo=docker&logoColor=white) |
...
| 수상명 | 내용 | 수상일 |
| :--- | :--- | :---: |
| **요기요 × 오라클 해커톤 우수상 (2nd place)** | 외국인을 위한 AI 푸드 컨시어지 | 2026.08.25 |
| **Healthcare Agentic AI Challenge 2026 우수상 (3rd place)** | TRIAL-OPT · 검증 가능한 임상시험 사전선별 연구 프로토타입 | 2026.09.04 |
...
| 시험 | 성적 | 취득일 |
| :--- | :---: | :---: |
| **TOEIC Speaking** | **Advanced Low (160)** | 2026.07.04 |
