...
| 프로젝트 | 기간 | 한 일 | 결과 |
| :--- | :---: | :--- | :---: |
| 🍽️ **[YOBI](https://github.com/barleylover/YOBI)** | 2026.07–08 | 외국인 관광객을 위한 음식 추천 및 설명 서비스<br>• 사용자 선택에 따른 메뉴 추천과 추천 이유 제공<br>• React·FastAPI 기반 서비스 구현<br>• Oracle Database 연동 및 OCI 배포<br>• 자동화 테스트와 공개 환경 E2E 검증 | **🏆 요기요 × 오라클<br>해커톤 우수상** |
