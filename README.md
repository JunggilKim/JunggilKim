...
| 🧬 **[TRIAL-OPT](https://github.com/JunggilKim/Healthcare_Agent)** | 2026.08–09 | 임상시험 사전 선별을 위한 연구 프로토타입<br>• 검색 단서와 판정 근거를 분리하는 Evidence Firewall 구현<br>• 부족한 정보를 우선순위에 따라 묻고 답변 후 판정을 재검증하는 흐름 개발<br>• FastAPI·React 기반 오프라인 데모와 Google Cloud 배포 | **🏆 SKKU Healthcare Agentic AI Challenge 2026<br>우수상 (3rd place)** |
...
| **SKKU Healthcare Agentic AI Challenge 2026 우수상 (3rd place)** | TRIAL-OPT · 검증 가능한 임상시험 사전선별 연구 프로토타입 | 2026.09.04 |
